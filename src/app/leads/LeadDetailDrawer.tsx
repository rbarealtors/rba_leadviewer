      ...
      <div className="fixed inset-y-0 right-0 max-w-lg w-full bg-panel shadow-2xl flex flex-col border-l border-line z-50 animate-in slide-in-from-right duration-200">
        ...
        <div className="px-6 py-4 border-b border-line bg-canvas/40 flex items-center justify-between gap-4">
          <div className="min-w-0">
            ...
            {lead.needs_staff_review && (
              <div className="mt-2 inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-rose-50 text-rose-800 border border-rose-200">
                <svg className="w-4 h-4 shrink-0 text-rose-600" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
                <span className="text-xs font-medium leading-tight">
                  3 consecutive no-answers — consider reassigning or trying a different number
                </span>
              </div>
            )}
            <p className="text-xs text-subtle mt-1" suppressHydrationWarning>
