...
export function SourceBadge({
  ...
  // Fallback for new manual sources
  let label = "Unknown";
  if (source === "direct_walk_in") label = "Direct Walk-in";
  else if (source === "phone_call") label = "Phone Call";
  else if (source === "referral") label = "Referral";
  else label = source;
